...
- при запуске программы должен создаваться новый файл, в конце работы программы файл удаляется
...
- если делайте на 5, то постарайтесь добиться того, чтобы major fault был больше 0, для этого нужно очистить page cache (почитайте и разберитесь самостоятельно)
...
- постановка задания
- процесс решения
- полученные результаты (скрины результата работы программы)
